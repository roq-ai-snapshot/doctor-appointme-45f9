...
import { getMedicineStaffById } from 'apiSdk/medicine-staffs';
import { MedicineStaffInterface } from 'interfaces/medicine-staff';

function MedicineStaffViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Medicine Staff Details
                  </Text>
                </Box>
                {hasAccess('medicine_staff', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/medicine-staffs/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Patient Profiles" text={data?.patient_profiles} />

                <FormListItem label="Appointment Bookings" text={data?.appointment_bookings} />
