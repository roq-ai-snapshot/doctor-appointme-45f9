...
import { getInsuranceProviderById } from 'apiSdk/insurance-providers';
import { InsuranceProviderInterface } from 'interfaces/insurance-provider';

function InsuranceProviderViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('insurance_provider', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/insurance-providers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Insurance Plans" text={data?.insurance_plans} />
