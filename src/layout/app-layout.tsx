...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'healthcare-provider', 'medical-staff', 'insurance-provider'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Guests', path: '/guests', entity: 'guest', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    {
    ...
    {
      name: 'Medicine Staffs',
      path: '/medicine-staffs',
